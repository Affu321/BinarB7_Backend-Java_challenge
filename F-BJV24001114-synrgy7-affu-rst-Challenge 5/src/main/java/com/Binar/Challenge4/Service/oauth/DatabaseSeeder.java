...
import com.Binar.Challenge4.Entity.oauth.RolePath;
import com.Binar.Challenge4.Entity.oauth.UserOauth;
import com.Binar.Challenge4.Repository.oauth.ClientRepository;
import com.Binar.Challenge4.Repository.oauth.RolePathRepository;
import com.Binar.Challenge4.Repository.oauth.RoleRepository;
...
public class DatabaseSeeder implements ApplicationRunner {
    ...
    public void insertUser(String password) {
        for (String userNames: users) {
            ...
            UserOauth oldUser = userRepository.findOneByUsername(username);
            if (null == oldUser) {
                oldUser = new UserOauth();
